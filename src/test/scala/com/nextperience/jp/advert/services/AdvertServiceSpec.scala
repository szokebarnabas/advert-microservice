...
class AdvertServiceSpec extends WordSpec with Matchers with ScalatestRouteTest with BeforeAndAfter with JsonSupport {
  ...
  private val advert2: Advert = Advert(2, "title2", "desc2", 20000, "CONTRACT", "me")
  private val advert3: Advert = Advert(3, "title3", "desc3", 30000, "CONTRACT", "me")
  private val advert4: Advert = Advert(4, "title4", "desc4", 50000, "CONTRACT", "me")
