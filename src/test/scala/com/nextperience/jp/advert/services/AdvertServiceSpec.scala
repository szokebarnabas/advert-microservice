...
class AdvertServiceSpec extends WordSpec with Matchers with ScalatestRouteTest with BeforeAndAfter with JsonSupport {
  ...
  private val advert1: Advert = Advert(None, "title1", "desc1", 10000, JobType.CONTRACT, "me")
  private val advert2: Advert = Advert(None, "title2", "desc2", 20000, JobType.CONTRACT, "me")
